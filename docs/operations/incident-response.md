...
For regional outages, destructive recovery, or suspected credential compromise,
follow the containment and staged recovery procedure in
[Disaster Recovery and Regional Failover](./disaster-recovery.md). Contract
`has_access` checks must never be bypassed to restore availability.
